package com.codewiz.chatenginerag.advisor;
...
public class CustomChatMemoryAdvisor extends AbstractChatMemoryAdvisor<VectorStore> {
    ...
    public CustomChatMemoryAdvisor(VectorStore vectorStore) {
        this(vectorStore, DEFAULT_SYSTEM_TEXT_ADVISE);
    }

    public CustomChatMemoryAdvisor(VectorStore vectorStore, String systemTextAdvise) {
        super(vectorStore);
        this.systemTextAdvise = systemTextAdvise;
    }

    public CustomChatMemoryAdvisor(VectorStore vectorStore, String defaultConversationId,
